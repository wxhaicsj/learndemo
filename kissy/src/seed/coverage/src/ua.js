...
function visit597_378_1(result) {
...
function visit596_356_1(result) {
...
function visit595_353_1(result) {
...
function visit594_345_2(result) {
...
function visit589_333_1(result) {
...
function visit585_316_1(result) {
...
function visit584_314_1(result) {
...
function visit583_296_1(result) {
...
function visit582_290_1(result) {
...
function visit581_285_1(result) {
...
function visit579_278_1(result) {
...
function visit575_256_1(result) {
...
function visit573_248_1(result) {
...
function visit572_244_1(result) {
...
function visit571_239_1(result) {
...
function visit570_235_1(result) {
...
function visit569_231_1(result) {
...
function visit568_228_1(result) {
...
function visit563_195_1(result) {
...
(function(S, undefined) {
  ...
  var win = S.Env.host, doc = win.document, navigator = win.navigator, ua = visit556_11_1(visit557_11_2(navigator && navigator.userAgent) || '');
  ...
  function setTridentVersion(ua, UA) {
    ...
    if (visit559_26_1((m = ua.match(/Trident\/([\d.]*)/)) && m[1])) {
  ...
  function getIEVersion(ua) {
    ...
    if (visit560_35_1((m = ua.match(/MSIE ([^;]*)|Trident.*; rv(?:\s|:)?([0-9.]+)/)) && (v = (visit561_36_1(m[1] || m[2]))))) {
  ...
  function getDescriptorFromUserAgent(ua) {
    ...
    var EMPTY = '', os, core = EMPTY, shell = EMPTY, m, IE_DETECT_RANGE = [6, 9], ieVersion, v, end, VERSION_PLACEHOLDER = '{{version}}', IE_DETECT_TPL = '<!--[if IE ' + VERSION_PLACEHOLDER + ']><' + 's></s><![endif]-->', div = visit562_53_1(doc && doc.createElement('div')), s = [];
  ...
  nodejs: undefined};
    ...
    if (visit563_195_1(div && div.getElementsByTagName)) {
    ...
    UA.core = visit592_343_1(UA.core || core);
    _$jscoverage['/ua.js'].lineData[344]++;
    UA.shell = shell;
    _$jscoverage['/ua.js'].lineData[345]++;
    UA.ieMode = visit593_345_1(visit594_345_2(UA.ie && doc.documentMode) || UA.ie);
  ...
  if (visit595_353_1(typeof process === 'object')) {
    _$jscoverage['/ua.js'].lineData[354]++;
    var versions, nodeVersion;
    _$jscoverage['/ua.js'].lineData[356]++;
    if (visit596_356_1((versions = process.versions) && (nodeVersion = versions.node))) {
  ...
  var browsers = ['webkit', 'trident', 'gecko', 'presto', 'chrome', 'safari', 'firefox', 'ie', 'opera'], documentElement = visit597_378_1(doc && doc.documentElement), className = '';
  _$jscoverage['/ua.js'].lineData[380]++;
  if (visit598_380_1(documentElement)) {
  ...
  if (visit599_383_1(v)) {
    ...
    if (visit600_388_1(S.trim(className))) {
